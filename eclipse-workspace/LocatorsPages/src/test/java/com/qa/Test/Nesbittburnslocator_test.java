...
public class Nesbittburnslocator_test extends TestBase {
	...
	/*
	 * @Test(priority = 5) public void VerifyGetDirection_test() throws
	 * InterruptedException { bmo.VerifyGetDirection(); Thread.sleep(5000);
	 * bmo.searchbylocation(); }
	 * 
	 * @Test(priority = 6) public void VerifySendToMobile_test() throws
	 * InterruptedException { bmo.VerifySendToMobile(); }
	 * 
	 * @Test(priority = 7) public void Verifyprofiledetails_test() throws
	 * InterruptedException { bmo.verify_profiledetails(); Thread.sleep(5000);
	 * bmo.searchbylocation(); }
	 * 
	 * @Test(priority = 8) public void VerifyEmailMe_test() throws
	 * InterruptedException { bmo.VerifyEmailMe();
	 * 
	 * }
	 */
